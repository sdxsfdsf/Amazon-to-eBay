...
(function () {
   ...
   * Re-derived from the live DOM at call time — amazonCapture.js's
   * captureCurrentVariant() calls this fresh on every capture, so a variant
   * change never reuses a previous variant's return status.
   */
