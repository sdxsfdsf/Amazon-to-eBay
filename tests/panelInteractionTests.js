...
(async () => {
  ...
  console.log("\n[P9] Advanced Pricing settings UI: renders, and saving produces the expected shape");
  {
    ...
    ck("Return Policy auto-fill checkbox label present", !!returnPolicyLabel);
    ...
    ck("an enable checkbox exists (Auto Fill's 7 + Advanced Pricing's 1 = 8)", checkboxes.length === 8, String(checkboxes.length));
